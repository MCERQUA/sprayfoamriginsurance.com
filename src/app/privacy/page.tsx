          ...
          <FadeIn>
            ...
            <div className="prose-warm mt-8">
              ...
              <ul>
                ...
                <li>Information about your spray foam rig and operation needed to quote insurance (proportioner make/model/value, hose footage, rig truck details, crew size, payroll, loss history)</li>
