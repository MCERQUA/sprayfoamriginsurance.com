          ...
          <div className="container-tight max-w-3xl">
            <FadeIn>
              ...
              <div className="mt-12 p-7 rounded-3xl bg-espresso text-cream">
                <p className="font-heading font-extrabold text-cream text-xl">Need this coverage for your spray foam rig?</p>
                <p className="text-cream/75 mt-2 text-sm">Get a real quote in about 15 minutes — we shop A-rated specialty contractor equipment markets.</p>
